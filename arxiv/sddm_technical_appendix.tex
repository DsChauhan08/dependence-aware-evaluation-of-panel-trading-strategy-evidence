...
\section{Optional Capacity-Stress Note}
...
optional extension to the statistical claim boundary.
...
strategy; it verifies that the composite audit gate can accept a
declared positive signal when the data-generating process contains one.
