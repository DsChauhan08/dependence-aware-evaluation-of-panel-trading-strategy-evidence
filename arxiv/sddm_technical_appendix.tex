...
validation, and generated public-data artifacts omitted from the main
...
turnover-stress convention as the public artifacts.
...
moving from rows to date returns, whether nearby HAC/bootstrap variants
agree, and whether placebo or cost diagnostics overturn the simple
