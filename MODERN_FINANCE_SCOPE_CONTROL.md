# Modern Finance Scope Control

This note records the submission boundary for the Modern Finance version.

The current manuscript is a focused specialty-journal methods submission:
sampling-boundary distortion in Sharpe-ratio evidence from financial panels,
Sharpe UVIF as a diagnostic variance-ratio, date-level HAC/bootstrap
inference, public benchmark and stress-test evidence, a synthetic positive
...
diagnostics as uninformative/N/A, and preserve the existing Modern Finance
package structure.
